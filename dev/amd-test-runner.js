...
console.log('Loading UnderscoreBetween qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading UnderscoreBetween qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing UnderscoreBetween qUnit tests.');
